...
Color scales for scatterplot 1 and 3 with 'true/false' only is comprised of two colors (one for true and one for false) and color scale for scatterplot 2 with a scale from 0 to 100 is comprised of a gradient moving from black at 0 to blue at 100. 
